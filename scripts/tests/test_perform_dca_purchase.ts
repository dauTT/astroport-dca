...
export async function test_perform_dca_purchase_for_order_1() {
  ...
  try {
    ...
    let tipAssetBefore = new TokenAsset(network.tokenAddresses.CCC, "1000000");
    ...
    let spentAssetAfter = new TokenAsset(network.tokenAddresses.AAA, "1000000");
    let tagetAssetAfter = new TokenAsset(network.tokenAddresses.BBB, "996991");
    let gasAssetAfter = new NativeAsset("uluna", "1000000");
    //let tipAssetAfter = new TokenAsset(network.tokenAddresses.AAA, "9900000");
